...
| Letterboxd Slug | Letterboxd searches using this. This is also used to pull latest data from Letterboxd; if a slug is not already in the data, program adds it. (e.g. Slug for V for Vendetta is 'v-for-vendetta')|
